...
\begin{figure}[bt!]
	\centering
	\hspace*{-0.3cm}\includegraphics[scale=0.38]{{./GTIBDRPicx/LOAD_DR_CUR.eps}}
 \vspace{-3mm}
...
\begin{figure}[bt!]
 ...
 \vspace{-3mm}
	\raggedleft
	\hspace*{-0.5cm}\includegraphics[width=0.55\textwidth]{{./GTIBDRPicx/LOSS_33.eps}}
...
\begin{figure}[bt!]
	\centering
	\hspace*{-0.3cm}\includegraphics[scale=0.38]{{./GTIBDRPicx/LOAD_DR_CUR_108.eps}}
 \vspace{-3mm}
	\caption{(a) Load pattern before and after DR and (b) Class-wise demand contribution.}
 \vspace{-3mm}
